...
Accordingly, everyone who participates in the Infectious Diseases Toolkit is expected to show respect and courtesy to other community members at all times.
...
The Infectious Diseases Toolkit team are dedicated to providing a welcoming and supportive environment for all people, regardless of background or identity.
...
This applies to all Infectious Diseases Toolkit community events and platforms, either online or in-person.
...
This is the enforcement manual followed by the Infectious Diseases Toolkit project team.
...
This can include contacting law enforcement (or other local personnel) and speaking on behalf of the Infectious Diseases Toolkit team.
...
* A permanent or temporary ban from some or all Infectious Diseases Toolkit spaces (GitHub, in-person events etc).
