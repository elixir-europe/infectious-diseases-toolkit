...
* `related_pages`: List here the `page_id` of Infectious Diseases Toolkit pages that you want to display as Related pages, grouped by section (Your tasks, Your domain, Tool assembly).
